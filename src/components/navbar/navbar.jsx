...
function Navbar() {
  return (
      <AppBar>
        <Toolbar style={{backgroundColor:"#000000" , color:"#F59300"}}>
            <Grid container>
                <Grid  style={{ display: "flex", justifyContent: "flex-start"}} item sm={3}>
                    <EmailIcon fontSize='large'/>
                  <Typography variant="h5" style={{marginLeft:'10px',fontFamily: 'Times New Roman',fontSize:"20px"}}>
        ...
        <Toolbar style={{backgroundColor:'#F59300', color:"white", fontSize:"20px"}}>
            <Grid container alignItems="center">
                ...
                <Grid item sm={1}>
                    <Typography variant="h5" style={{marginRight:'20px',fontFamily: 'Times New Roman',fontSize:"30px"}}>
                        About Me    
                    </Typography>
                </Grid>
                <Grid item sm={1}>
                    <Typography variant="h5" style={{fontFamily: 'Times New Roman',fontSize:"30px"}}>
                        Consult   
                    </Typography>
                </Grid>
                <Grid item sm={1}>
