...
export const News3CardDemo2 = React.memo(function News3Card() {
        ...
        >
          ...
          <Info position={'middle'} useStyles={useNewsInfoStyles}>
            ...
            <InfoSubtitle>Jul 20 | 2 Min Read</InfoSubtitle> */}
             <img src={medifit} alt="" width='325px'height='80px' style={{border:"3px solid black"}}/>
          </Info>
        </Row>
